	...
	override function create()
	{
		...
		options = [
			...
			new OptionCata(345, 40, "Appearance", [
				...
				new CompactNumbers("if you want Score, combo, misses and NPS to be compact."),
				...
				new PlayerStrums("CpuStrums option but for the player"),
				new ColorQuantization("Notes are colored based on their quantization"),
				new TransparentScore("Score and Judgment bar become slightly transparent"),
				new MoreMaxHP("Increases your max health to 150% instead of 100%"), // easy mode
			...
			new OptionCata(640, 40, "Misc", [
				...
				new DevMode("Allows botplay on any song"),
				new LanguageOption()
			]),
