...
class ModifiersState extends FlxSubState
{
	...
	public static var onPlayStateM:Bool = false;
	...
	override function create()
	{
		...
		modifiers = [
		    ...
		    new MainaNotes("How many keys you want to add (Recommended to turn on Randomized Notes)"),
		    new RandomScrollSpeed("Unfairness note speed"),
